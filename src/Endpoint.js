...
import InstantMessageStatus from './InstantMessageStatus'
...
export default class Endpoint extends EventEmitter {
  constructor() {
    ...
    DeviceEventEmitter.addListener(
      'pjSipTypingIndicationReceived',
      this._onTypingIndicationReceived.bind(this),
    );
    DeviceEventEmitter.addListener(
      'pjSipMessageStatusReceived',
      this._onMessageStatusReceived.bind(this),
    );
    DeviceEventEmitter.addListener(
  ...
  /**
   * @fires Endpoint#typing_indication_received
   * @private
   * @param data {Object}
   */
  _onTypingIndicationReceived(data) {
    /**
     *
     * @event Endpoint#typing_indication_received
     * @property {TypingIndication} typingIndication
     */
    this.emit('typing_indication_received', new TypingIndication(data));
  }

  /**
   * @fires Endpoint#message_status_received
   * @private
   * @param data {Object}
   */
  _onMessageStatusReceived(data) {
    /**
     *
     * @event Endpoint#message_status_received
     * @property {InstantMessageStatus} instantMessageStatus
     */
    this.emit('message_status_received', new InstantMessageStatus(data));
  }
